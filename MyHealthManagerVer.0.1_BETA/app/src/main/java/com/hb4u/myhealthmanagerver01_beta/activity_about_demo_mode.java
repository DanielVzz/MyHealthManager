...
public class activity_about_demo_mode extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_about_demo_mode);
    }
...
//        inflater.inflate(R.menu.stop, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (selectedMenuIdString.equals("item_scan_code")) {
            Intent myIntent = new Intent(activity_about_demo_mode.this, scanning_screen.class);
            activity_about_demo_mode.this.startActivity(myIntent);
            onPause();
...
//            onPause();
            ...
            Intent myIntent = new Intent(activity_about_demo_mode.this, settings.class);
            activity_about_demo_mode.this.startActivity(myIntent);
            onPause();
        }
        else if (selectedMenuIdString.equals("itemabout")) {
            Intent myIntent = new Intent(activity_about_demo_mode.this, about.class);
            activity_about_demo_mode.this.startActivity(myIntent);
            onPause();
        } else if(selectedMenuIdString.equals("item_getpremium")){
            Intent myIntent = new Intent(activity_about_demo_mode.this, get_premium.class);
            activity_about_demo_mode.this.startActivity(myIntent);
            onPause();
        }else if(selectedMenuIdString.equals("item_demo_mode")){
            Intent myIntent = new Intent(activity_about_demo_mode.this, activity_demo_mode.class);
            activity_about_demo_mode.this.startActivity(myIntent);
            onPause();
        }
